...
export default class Group extends Component {
    render() {
        ...
        return (
            <div id="paketGroup" className="row tab-pane active">
                <div className="col-lg-9 col-md-9 col-xs-12" style={{margin: 'auto'}}>
                    ...
                    <div className="tab-content">
                        <Switch>
                            ...
                            <Route exact path={`${path}/description`} component={GroupDescription}/>
                            <Route exact path={`${path}/itinerary`} component={GroupItinerary}/>
